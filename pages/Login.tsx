  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-primary/10 via-background to-accent/10 flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              <div className="space-y-3">
                ...
                <Input
                  ...
                  className="h-12 rounded bg-white border-gray-600/50 focus:border-primary"
                  required
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-12 rounded bg-white border-gray-600/50 focus:border-[#22263f] pr-12"
                    required
                  />
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 rounded bg-[#2178c4] text-white font-normal text-lg transition-opacity hover:opacity-90 active:scale-[0.98] disabled:opacity-70 flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
      ...
      <footer className="py-6 text-center">
        <p className="text-xs text-gray-500">© 2026 The Goldman Sachs Group, Inc. All rights reserved.</p>
      </footer>
    </div>
  );
}
