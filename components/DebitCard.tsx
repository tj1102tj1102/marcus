...
const DebitCard = ({ cardNumber = '**** **** **** 7890', cardHolder = 'JAMES ANDERSON', expiryDate = '12/28', cvv = '***' }: DebitCardProps) => {
  ...
  return (
    <div
      className="bg-[#22263f] relative shadow-sm rounded-2xl p-6 cursor-pointer transition-all duration-300 ease-out transform-style-3d"
      style={{
    ...
    >
      ...
      <div className="flex justify-between items-center mb-5">
        ...
        <div className="flex items-center gap-2">
          <Image src="https://i.postimg.cc/NjmMp6hR/slazzer-preview-q4rbv.png" width={100} height={20} className="w-[50px] h-[50px] rounded-2xl" alt="logo" />
        </div>

        {/* Contactless Icon */}
        <div className="text-white-muted">
          <Wifi className="w-7 h-7 text-white rotate-90" strokeWidth={1.5} />
        </div>
      </div>
